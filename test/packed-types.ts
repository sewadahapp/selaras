...
const packedThemeConfiguration: ThemeConfiguration = {
  ...
  ui: {
    ...
    avatarGroup: { compoundVariants: [{ size: 'lg', class: { root: 'gap-2' } }] },
    breadcrumb: { compoundVariants: [{ color: 'secondary', class: { link: 'underline-offset-4' } }] },
    button: { slots: { base: 'rounded-full' } },
    buttonGroup: { compoundVariants: [{ orientation: 'vertical', class: { root: 'gap-2' } }] },
    callout: { compoundVariants: [{ type: 'danger', class: { root: 'shadow-sm' } }] },
    ...
    contentNavigation: { compoundVariants: [{ color: 'primary', isNested: true, class: { item: 'font-semibold' } }] },
    contentSurround: { compoundVariants: [{ color: 'secondary', align: 'end', class: { link: 'font-semibold' } }] },
    contentToc: { compoundVariants: [{ color: 'primary', active: true, class: { link: 'font-semibold' } }] },
    ...
    inputGroup: { compoundVariants: [{ orientation: 'vertical', class: { root: 'gap-2' } }] },
    ...
    progress: { compoundVariants: [{ color: 'primary', size: 'lg', indeterminate: true, class: { root: 'shadow-sm' } }] },
    ...
    readMore: { compoundVariants: [{ color: 'primary', open: false, class: { root: 'shadow-sm' } }] },
    select: { compoundVariants: [{ color: 'primary', invalid: true, class: { trigger: 'font-semibold' } }] },
    scrollArea: { slots: { root: 'max-h-64' } },

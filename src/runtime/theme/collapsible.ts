...
export const collapsibleTheme = tv({
  slots: {
    root: 'w-full',
    trigger: 'group flex w-full items-center justify-between gap-2 text-start font-medium text-[var(--selaras-resolved-text-default)] transition-colors hover:text-[var(--_selaras-color-text-hover)] disabled:opacity-50 disabled:pointer-events-none',
    ...
    content: 'overflow-hidden text-[var(--selaras-resolved-text-muted)] data-[state=open]:animate-[selaras-collapsible-down_200ms_ease-out] data-[state=closed]:animate-[selaras-collapsible-up_200ms_ease-out]',

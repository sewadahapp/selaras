...
export const accordionTheme = tv({
  slots: {
    ...
    content: 'overflow-hidden text-sm text-[var(--ui-text-muted)] data-[state=open]:animate-[selaras-accordion-down_200ms_ease-out] data-[state=closed]:animate-[selaras-accordion-up_200ms_ease-out]',

...
export const proseTheme = tv({
  slots: {
    ...
    blockquote: 'border-l-2 border-[var(--ui-border)] pl-4 italic text-[var(--ui-text-muted)]',
    ...
    li: 'text-[var(--ui-text)]',
    ol: 'list-decimal space-y-1 pl-6 text-[var(--ui-text)]',
    ...
    th: 'border-b border-[var(--ui-border)] px-3 py-2 text-left font-medium text-[var(--ui-text-muted)]',
    thead: 'bg-[var(--ui-bg-elevated)]',
    tr: '',
    ul: 'list-disc space-y-1 pl-6 text-[var(--ui-text)]',

...
export const radioGroupTheme = tv({
  ...
  variants: {
    ...
    // same has-[[data-state=checked]] the disabled look already uses.
    variant: {
      default: {},
      card: {
        itemWrapper: 'w-full items-start gap-3 rounded-[var(--ui-radius-md)] border border-[var(--ui-border)] px-3.5 py-3 transition-colors has-[[data-state=checked]]:border-[var(--ui-primary)] has-[[data-state=checked]]:bg-[var(--ui-primary-soft)]',
        item: 'mt-0.5',
      },
    },

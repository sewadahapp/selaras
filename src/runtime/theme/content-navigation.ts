...
export const contentNavigationTheme = tv({
  slots: {
    ...
    trigger: 'group flex w-full items-center justify-between gap-2 rounded-[var(--ui-radius-sm)] px-2 py-2.5 text-left font-medium text-[var(--ui-text)] transition-colors hover:bg-[var(--ui-bg-elevated)]',

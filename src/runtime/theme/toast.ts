...
export const toastTheme = tv({
  slots: {
    ...
    // touch target now come from Button's own theme; only positioning
    // (this card doesn't lay it out via flex, unlike Modal's header) stays
    // here.
    close: 'absolute right-2 top-2 shrink-0',
  },
})

...
export const selectTheme = tv({
  slots: {
    trigger: 'inline-flex w-full items-center justify-between gap-2 rounded-[var(--ui-radius-md)] bg-[var(--ui-bg)] px-3 text-sm ring-1 ring-inset ring-[var(--ui-border)] transition-colors focus:outline-2 focus:outline-offset-1 focus:outline-[var(--ui-primary)] disabled:opacity-50 disabled:pointer-events-none data-[placeholder]:text-[var(--ui-text-muted)]',

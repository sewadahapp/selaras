...
export const switchTheme = tv({
  slots: {
    ...
    track: 'group relative inline-flex h-4.5 w-8 shrink-0 items-center rounded-[var(--ui-radius-full)] bg-[var(--_selaras-color-border)] transition-colors focus-visible:outline-none data-[state=checked]:bg-[var(--_selaras-color-fill)]',

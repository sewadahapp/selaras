...
export const scrollAreaTheme = tv({
  slots: {
    ...
    thumb: 'relative flex-1 rounded-full bg-[var(--selaras-resolved-border-default)] before:absolute before:left-1/2 before:top-1/2 before:h-full before:min-h-11 before:w-full before:min-w-11 before:-translate-x-1/2 before:-translate-y-1/2',
    corner: 'bg-[var(--selaras-resolved-surface-elevated)]',
  },
})

...
export type * from '../components/ProseA.vue'
export type * from '../components/ProseBlockquote.vue'
export type * from '../components/ProseCode.vue'
export type * from '../components/ProseEm.vue'
...
export type * from '../components/ProseHr.vue'
export type * from '../components/ProseImg.vue'
export type * from '../components/ProseLi.vue'
export type * from '../components/ProseOl.vue'
export type * from '../components/ProseP.vue'
export type * from '../components/ProsePre.vue'
export type * from '../components/ProseStrong.vue'
export type * from '../components/ProseTable.vue'
export type * from '../components/ProseTbody.vue'
export type * from '../components/ProseTd.vue'
export type * from '../components/ProseTh.vue'
export type * from '../components/ProseThead.vue'
export type * from '../components/ProseTr.vue'
export type * from '../components/ProseUl.vue'
